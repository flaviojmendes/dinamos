    ...
    <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl p-6 border border-blue-500/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-brand-600 dark:text-brand-400">{t(`${base}.pillars.metrics.title`)}</h3>
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.use_method_title`)}</h3>
            <p className="text-slate-600 dark:text-slate-300 mb-4">{t(`${base}.use_method_p`)}</p>
          ...
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-4">{t(`${base}.red_method_p`)}</p>
            <ul className="space-y-3">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Metrics Tools */}
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.tools.metrics_title`)}</h3>
            <ul className="space-y-3">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl p-6 border border-blue-500/20">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.sli_card.title`)}</h3>
            <p className="text-slate-600 dark:text-slate-300 mb-4">{t(`${base}.sli_card.desc`)}</p>
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 rounded-xl p-6 border border-purple-500/20">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-4">{t(`${base}.slo_card.desc`)}</p>
            <ul className="space-y-2 text-slate-600 dark:text-slate-300 text-sm">
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-green-600/10 rounded-xl p-6 border border-green-500/20">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-4">{t(`${base}.sla_card.desc`)}</p>
            <ul className="space-y-2 text-slate-600 dark:text-slate-300 text-sm">

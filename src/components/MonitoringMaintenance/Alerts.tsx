      ...
      >
        ...
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.thresholds_title`)}</h3>
    ...
    "notifications": [
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Synchronous */}
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.sync_title`)}</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.sync_channels.sms.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.sync_channels.calls.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.sync_channels.pagerduty.desc`)}</p>
                </div>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.async_channels.email.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-purple-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.async_channels.slack.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-purple-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.async_channels.dashboards.desc`)}</p>
                </div>
              </li>
            </ul>
          </div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.process_steps.detection.desc`)}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.process_steps.response.desc`)}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.process_steps.mitigation.desc`)}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.process_steps.resolution.desc`)}</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.alert_config_title`)}</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.alert_practices.actionable.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.alert_practices.noise_reduction.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.alert_practices.context.desc`)}</p>
                </div>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.response_practices.playbooks.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-purple-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.response_practices.escalation.desc`)}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-purple-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.response_practices.postmortem.desc`)}</p>
                </div>
              </li>
            </ul>
          </div>

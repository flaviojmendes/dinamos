  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.categories.system_title`)}</h3>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl p-6 border border-blue-500/20">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.availability_card.title`)}</h3>
      ...
      >
        ...
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
          <p className="text-slate-600 dark:text-slate-300 mb-4">{t(`${base}.prom_desc`)}</p>
...
process_resident_memory_bytes`}
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">{t(`${base}.prom_outro`)}</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4 text-brand-600 dark:text-brand-400">{t(`${base}.collect_title`)}</h3>
            <ul className="space-y-3">

      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.api_gateway.auth_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
              {t('components.api_gateway.auth_p')}
            </p>
            <div className="mt-4 bg-slate-100 dark:bg-slate-800 p-4 rounded">
              <p className="font-medium text-brand-600 dark:text-brand-200">{t('components.common.example')}</p>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.api_gateway.routing_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.api_gateway.ratelimit_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.api_gateway.aggregation_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">

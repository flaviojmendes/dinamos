  ...
  return (
    <div className="p-6 md:p-8 lg:p-12 max-w-4xl mx-auto">
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <p className="text-slate-700 dark:text-slate-200 mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.load_balancer_page.rr_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
              {t('components.load_balancer_page.rr_p')}
            </p>
            <div className="mt-4 bg-slate-100 dark:bg-slate-800 rounded p-4">
              <p className="font-medium text-brand-600 dark:text-brand-200 mb-2">{t('components.load_balancer_page.how_it_works')}</p>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.load_balancer_page.hashing_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
              {t('components.load_balancer_page.hashing_p')}
            </p>
            <div className="mt-4 bg-slate-100 dark:bg-slate-800 rounded p-4">
              <p className="font-medium text-brand-600 dark:text-brand-200 mb-2">{t('components.load_balancer_page.use_case')}</p>
              <p className="text-slate-600 dark:text-slate-300">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.load_balancer_page.least_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
              {t('components.load_balancer_page.least_p')}
            </p>
            <div className="mt-4 bg-slate-100 dark:bg-slate-800 rounded p-4">
              <p className="font-medium text-brand-600 dark:text-brand-200 mb-2">{t('components.load_balancer_page.advantage')}</p>
              <p className="text-slate-600 dark:text-slate-300">

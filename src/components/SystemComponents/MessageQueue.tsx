      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="space-y-8">
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.message_queue_page.kafka_title')}</h3>
          ...
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.message_queue_page.rabbitmq_title')}</h3>
            <p className="text-zinc-200">
          ...
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.message_queue_page.sqs_title')}</h3>
            <p className="text-zinc-200">
        ...
        <div className="space-y-8">
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.message_queue_page.pubsub_header')}</h3>
            <p className="text-zinc-200">
          ...
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.message_queue_page.fifo_header')}</h3>
            <p className="text-zinc-200">

    ...
    <div className="min-h-screen bg-canvas-paper dark:bg-canvas-dark text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold mb-8 text-brand-600 dark:text-brand-400">{t('polling_webhooks_theory.problem_title')}</h2>
          <div className="bg-white dark:bg-slate-900/50 rounded-xl p-8 border border-slate-300 dark:border-slate-700/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
                <h3 className="text-xl font-bold text-brand-600 dark:text-brand-400 mb-3">{t('polling_webhooks_theory.problem_polling_title')}</h3>
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold mb-8 text-brand-600 dark:text-brand-400">{t('polling_webhooks_theory.polling_title')}</h2>
          
          <div className="bg-white dark:bg-slate-900/50 rounded-xl p-8 border border-slate-300 dark:border-slate-700/50 mb-8">
            <h3 className="text-2xl font-bold mb-6 text-brand-600 dark:text-brand-300">{t('polling_webhooks_theory.how_it_works')}</h3>
            <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-lg p-6 mb-6">
              <h4 className="text-lg font-bold text-brand-600 dark:text-brand-400 mb-4">{t('polling_webhooks_theory.typical_flow')}</h4>
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
            <h4 className="text-lg font-bold text-brand-600 dark:text-brand-400 mb-4">{t('polling_webhooks_theory.when_to_use_polling')}</h4>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-300 dark:border-slate-700/50 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-100 dark:bg-slate-800/50">
                    <th className="text-left p-4 text-slate-600 dark:text-slate-300 font-medium">{t('polling_webhooks_theory.table.aspect')}</th>
                    <th className="text-left p-4 text-brand-600 dark:text-brand-400 font-medium">{t('polling_webhooks_theory.table.polling')}</th>
                ...
                <tbody className="text-slate-600 dark:text-slate-300">
                  ...
                  <tr className="border-t border-slate-300 dark:border-slate-700/30">
                  ...
                  <tr className="border-t border-slate-300 dark:border-slate-700/30 bg-slate-100 dark:bg-slate-800/20">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Polling Examples */}
            <div className="bg-white dark:bg-slate-900/50 rounded-xl p-8 border border-blue-500/20">
              <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-400 mb-6">{t('polling_webhooks_theory.polling_use_cases')}</h3>
            </div>

            {/* Webhook Examples */}
            <div className="bg-white dark:bg-slate-900/50 rounded-xl p-8 border border-purple-500/20">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-slate-900/50 rounded-xl p-8 border border-slate-300 dark:border-slate-700/50">
              <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-400 mb-6">{t('polling_webhooks_theory.implementing_polling')}</h3>
              
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-brand-600 dark:text-brand-300 mb-3">{t('polling_webhooks_theory.common_strategies')}</h4>
                </div>
                
                <div>
                  <h4 className="text-lg font-bold text-brand-600 dark:text-brand-300 mb-3">{t('polling_webhooks_theory.important_care')}</h4>
                </div>
              </div>
            </div>

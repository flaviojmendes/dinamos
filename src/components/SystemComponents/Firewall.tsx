      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="space-y-6">
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.firewall.filtering_title')}</h3>
          ...
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.firewall.stateful_title')}</h3>
            <p className="text-zinc-200">
          ...
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.firewall.ips_title')}</h3>
            <p className="text-zinc-200">
        ...
        <div className="space-y-6">
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.firewall.net_fw_title')}</h3>
            <p className="text-zinc-200">
          ...
          <div className="bg-zinc-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-blue-200 mb-4">{t('components.firewall.app_fw_title')}</h3>
            <p className="text-zinc-200">

      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.cdn.benefit_latency_title')}</h3>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.cdn.benefit_load_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
            <h3 className="text-2xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('components.cdn.benefit_availability_title')}</h3>
            <p className="text-slate-700 dark:text-slate-200">
        ...
        <div className="bg-slate-100 dark:bg-slate-800 rounded p-4 mt-8">
          <p className="font-medium text-brand-600 dark:text-brand-200 mb-2">{t('components.cdn.example_label')}</p>

      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="space-y-6 text-zinc-200">
          ...
          <div className="bg-zinc-900 rounded-lg p-6 mt-8">
            <h3 className="text-2xl font-bold text-blue-200 mb-6">{t('components.cache.compare_title')}</h3>
            
            <div className="space-y-6">
              <div>
                <h4 className="text-xl font-bold text-blue-200 mb-2">{t('components.cache.simplicity_label')}</h4>
                <p>
              ...
              <div>
                <h4 className="text-xl font-bold text-blue-200 mb-2">{t('components.cache.datatypes_label')}</h4>
                <p>
              ...
              <div>
                <h4 className="text-xl font-bold text-blue-200 mb-2">{t('components.cache.persistence_label')}</h4>
                <p>
        ...
        <div className="space-y-6 text-zinc-200">
          <div className="bg-zinc-900 rounded-lg p-6">
            <div className="mb-6">
              <h4 className="text-xl font-bold text-blue-200 mb-2">{t('components.cache.local_cache_label')}</h4>
              <p>
            ...
            <div>
              <h4 className="text-xl font-bold text-blue-200 mb-2">{t('components.cache.distributed_cache_label')}</h4>
              <p>

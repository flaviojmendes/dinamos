  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        {/* Query terms */}
        <div className="mb-2 font-sans text-[11px] font-medium text-slate-500 dark:text-tactical-label">{t(`${base}.labels.query`)}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Documents */}
          <div>
            <div className="mb-2 font-sans text-[11px] font-medium text-slate-500 dark:text-tactical-label">{t(`${base}.labels.documents`)}</div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-1 flex flex-wrap gap-1">
                      {d.terms.map(term => (
                        <span key={term} className={`font-sans text-[10px] ${query.has(term) ? 'text-signal-cyan' : 'text-slate-400 dark:text-tactical-label'}`}>
                          {term}
                        </span>
                      ))}
                    </div>
          ...
          {/* Inverted index */}
          <div>
            <div className="mb-2 font-sans text-[11px] font-medium text-slate-500 dark:text-tactical-label">{t(`${base}.labels.index`)}</div>

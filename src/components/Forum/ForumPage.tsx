          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 mt-3">
              ...
              <div className="flex items-center gap-1.5 text-sm text-slate-500">
                ...
                <span>
                  {(topic.comment_count ?? 0) === 0
                    ? t('forum.no_comments')
                    : (topic.comment_count ?? 0) === 1
                      ? t('forum.comments_count_one', { count: topic.comment_count ?? 0 })
                      : t('forum.comments_count', { count: topic.comment_count ?? 0 })}
                </span>
              </div>
            </div>
          </div>

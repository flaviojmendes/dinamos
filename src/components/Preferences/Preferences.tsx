...
const linkPrimary =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap px-4 py-2 font-mono text-sm font-medium uppercase tracking-wider transition-colors bg-slate-900 text-white hover:bg-slate-700 dark:bg-white dark:text-black dark:hover:bg-slate-200';
const linkSecondary =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap px-4 py-2 font-mono text-sm font-medium uppercase tracking-wider transition-colors border border-slate-300 text-slate-700 hover:border-slate-900 hover:bg-slate-100 dark:border-tactical-line dark:text-tactical-text dark:hover:border-signal-green dark:hover:bg-tactical-raised';
...
export default function Preferences() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      >
        <div>
          <div className="label-mono text-signal-cyan mb-2">// SYSTEM CONFIG</div>
          <h1 className="font-mono text-2xl md:text-3xl font-bold uppercase tracking-wider text-slate-900 dark:text-tactical-text">
            {t('preferences.title')}
          </h1>
        </div>
        ...
        <Panel title={t('preferences.account_info')} accent="cyan">
          <dl className="divide-y divide-slate-200 dark:divide-tactical-border">
            <div className="flex items-center justify-between gap-4 py-2.5 first:pt-0">
              ...
              <dd className="font-mono text-sm text-slate-900 dark:text-tactical-text truncate">{user?.email}</dd>
            </div>
            <div className="flex items-center justify-between gap-4 py-2.5 last:pb-0">
              ...
              <dd className="font-mono text-sm text-slate-900 dark:text-tactical-text">
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <h3 className="font-mono text-sm font-semibold text-slate-900 dark:text-tactical-text mb-1">{t('preferences.cookie_preferences_title')}</h3>
                <p className="font-mono text-xs leading-relaxed text-slate-500 dark:text-tactical-dim">
            ...
            <div className="flex flex-col gap-3 border-t border-slate-200 pt-4 dark:border-tactical-border sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <h3 className="font-mono text-sm font-semibold text-slate-900 dark:text-tactical-text mb-1">{t('preferences.privacy_policy_title')}</h3>
                <p className="font-mono text-xs leading-relaxed text-slate-500 dark:text-tactical-dim">
            ...
            <div className="flex flex-col gap-3 border-t border-slate-200 pt-4 dark:border-tactical-border sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <h3 className="font-mono text-sm font-semibold text-slate-900 dark:text-tactical-text mb-1">{t('preferences.terms_title')}</h3>
                <p className="font-mono text-xs leading-relaxed text-slate-500 dark:text-tactical-dim">

  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-8">
        <div className="tactical-panel border-signal-green/40 p-6 flex flex-col items-center text-center">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-mono uppercase tracking-wider font-semibold text-signal-green">{t('common.free_editor')}</span>
            <Tag color="green">{t('landing.free_badge')}</Tag>
          </div>
          <div className="font-mono text-slate-600 dark:text-tactical-dim mb-4">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 flex items-center justify-center border border-signal-green/40 bg-signal-green/5">
                  <svg className="w-5 h-5 text-signal-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
                  </svg>
                </div>
                <div>
                  <h2 className="font-mono uppercase tracking-wider text-xl font-bold text-slate-900 dark:text-tactical-text">{t('landing.forum_section.title')}</h2>
                  <p className="font-mono text-sm text-slate-500 dark:text-tactical-dim">{t('landing.forum_section.subtitle')}</p>
                </div>
              </div>
              <Link
                to="/forum"
                className="flex items-center gap-1 font-mono uppercase tracking-wider text-signal-green hover:opacity-80 text-sm transition-opacity"
              >
                    ...
                    >
                      <div className="flex items-start gap-3">
                        {topic.author.avatar_image ? (
                          ...
                          <div
                            className="w-8 h-8 flex items-center justify-center text-white text-sm font-mono font-semibold"
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className={`font-mono text-[11px] uppercase tracking-wider ${categoryColor}`}>
                              [{topic.category}]
                            </span>
                            <span className="font-mono text-slate-400 dark:text-tactical-label text-xs">
                              {formatRelativeTime(topic.created_at)}
                            </span>
                          </div>
                          <h3 className="font-mono font-medium text-slate-900 dark:text-tactical-text truncate group-hover:text-signal-green transition-colors">
                            {topic.title}
                          </h3>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <Typography variant="h3" className="mb-3 font-mono uppercase tracking-wider text-signal-cyan">
              {t('landing.fundamentals_title')}
            </Typography>
            <ul className="space-y-2 font-mono text-sm text-slate-600 dark:text-tactical-dim">
              {[1, 2, 3, 4].map((n) => (
          ...
          >
            ...
            <Typography variant="h3" className="mb-3 font-mono uppercase tracking-wider text-signal-green">
          ...
          >
            ...
            <Typography variant="h3" className="mb-3 font-mono uppercase tracking-wider text-signal-red">
          ...
          <div className="space-y-12">
            ...
            >
              <div className="lg:text-right order-2 lg:order-1">
                <h3 className="font-mono uppercase tracking-wider text-2xl font-bold text-signal-cyan mb-4">{t('landing.journey_fundamentals_title')}</h3>
              ...
              <div className="relative order-1 lg:order-2">
                <div className="lg:pl-8">
                  <div className="tactical-panel border-l-2 border-l-signal-cyan p-6">
                    ...
                    <p className="font-mono text-sm text-slate-600 dark:text-tactical-dim">{t('landing.journey_fundamentals_description')}</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative">
                <div className="lg:pr-8">
                  <div className="tactical-panel border-r-2 border-r-signal-green p-6">
                    ...
                    <p className="font-mono text-sm text-slate-600 dark:text-tactical-dim">{t('landing.journey_design_principles_description')}</p>
                  </div>
                </div>
              </div>
              <div>
                <h3 className="font-mono uppercase tracking-wider text-2xl font-bold text-signal-green mb-4">{t('landing.journey_design_principles_title')}</h3>
                <ul className="space-y-3 font-mono text-sm">
                  {[1, 2, 3].map((n) => (
                    <li key={n} className="flex items-center gap-2">
                      <span className="text-signal-green">▸</span>
            ...
            >
              <div className="lg:text-right order-2 lg:order-1">
                <h3 className="font-mono uppercase tracking-wider text-2xl font-bold text-signal-amber mb-4">{t('landing.journey_advanced_topics_title')}</h3>
                <ul className="space-y-3 font-mono text-sm">
                  {[1, 2, 3].map((n) => (
                    <li key={n} className="flex items-center gap-2 lg:flex-row-reverse">
              ...
              <div className="relative order-1 lg:order-2">
                <div className="lg:pl-8">
                  <div className="tactical-panel border-l-2 border-l-signal-amber p-6">
                    ...
                    <p className="font-mono text-sm text-slate-600 dark:text-tactical-dim">{t('landing.journey_advanced_topics_description')}</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative">
                <div className="lg:pr-8">
                  <div className="tactical-panel border-r-2 border-r-signal-red p-6">
                    ...
                    <p className="font-mono text-sm text-slate-600 dark:text-tactical-dim">{t('landing.journey_real_cases_description')}</p>
                  </div>
                </div>
              </div>
              <div>
                <h3 className="font-mono uppercase tracking-wider text-2xl font-bold text-signal-red mb-4">{t('landing.journey_real_cases_title')}</h3>
                <ul className="space-y-3 font-mono text-sm">
                  {[1, 2, 3].map((n) => (
                    <li key={n} className="flex items-center gap-2">
                      <span className="text-signal-red">▸</span>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <Typography variant="h3" className="mb-2 font-mono uppercase tracking-wider text-signal-cyan">
          ...
          >
            ...
            <Typography variant="h3" className="mb-2 font-mono uppercase tracking-wider text-signal-green">
          ...
          >
            ...
            <Typography variant="h3" className="mb-2 font-mono uppercase tracking-wider text-signal-amber">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            >
              <h3 className="font-mono uppercase tracking-wider text-xl font-bold mb-4 text-signal-cyan">{t('landing.teacher_experience_title')}</h3>
              <ul className="space-y-3 font-mono text-sm">
            ...
            <motion.div
              ...
              className="tactical-panel p-6"
            >
              <h3 className="font-mono uppercase tracking-wider text-xl font-bold mb-4 text-signal-green">{t('landing.teacher_specialties_title')}</h3>
              <ul className="space-y-3 font-mono text-sm">
                <li className="flex items-start gap-3 text-slate-600 dark:text-tactical-dim">
          ...
          >
            <div className="space-y-6">
              <p className="font-mono text-sm text-slate-600 dark:text-tactical-dim leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <div className="inline-flex items-center gap-2 border border-signal-green/40 bg-signal-green/5 text-signal-green px-4 py-2 mb-6">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="font-mono uppercase tracking-wider font-bold">{t('landing.free_badge')}</span>
          </div>
          <Typography 
            variant="h2" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            <div className="text-center py-8">
              ...
              <p className="font-mono text-lg text-slate-600 dark:text-tactical-dim mb-8">
          ...
          >
            <div className="tactical-panel p-6">
              <h4 className="font-mono uppercase tracking-wider text-lg font-semibold mb-4 text-signal-cyan flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
            ...
            <div className="tactical-panel p-6">
              <h4 className="font-mono uppercase tracking-wider text-lg font-semibold mb-4 text-signal-amber flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <motion.div
          ...
          className="tactical-panel scanline border-signal-green/40 p-8 text-center relative overflow-hidden"
        >
          <div className="absolute inset-0 bg-grid [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]" />
          <div className="relative">
            <div className="inline-flex items-center gap-2 border border-signal-green/40 bg-signal-green/5 text-signal-green px-4 py-2 mb-4">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="font-mono uppercase tracking-wider font-bold">100% {t('landing.free_badge')}</span>
            </div>
            <h2 className="font-mono uppercase tracking-tight text-3xl font-bold mb-4 text-slate-900 dark:text-tactical-text">{t('landing.cta_free_title')}</h2>
            <p className="font-mono text-xl mb-8 text-slate-600 dark:text-tactical-dim">
              {t('landing.cta_free_subtitle')}
            </p>
            <Link
              to="/intro"
              onClick={() => trackEvent('User', 'Clicked on Final CTA - Free')}
              className="inline-block bg-signal-green hover:opacity-90 text-black px-8 py-3 text-lg font-mono uppercase tracking-wider font-medium transition-opacity"
            >
              {t('common.start_now')}
            </Link>
          </div>

...
export default function SSLTLS() {
  ...
  const getTextColor = (color: string) => {
    switch (color) {
      ...
      case 'blue': return 'text-brand-600 dark:text-brand-400';
  ...
  const getStepColorClass = (index: number) => {
    ...
    switch (color) {
      case 'blue': return 'bg-blue-500/20 text-brand-600 dark:text-brand-400';
                  ...
                  <div className="space-y-4">
                    {evolutionVersions.map((version, index) => (
                      <div key={index} className={`border-l-2 ${getColorClass(version.color)} pl-4`}>
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm">{version.status}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4">
                  {handshakeSteps.map((step, index) => (
                    <div key={index} className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg">
          ...
          <section>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
              <div className="grid gap-6">
                <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg border-l-4 border-green-500">
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg border-l-4 border-blue-500">
                  <h3 className="text-xl font-semibold text-brand-600 dark:text-brand-400 mb-3">{t(`${base}.certificates_title`)}</h3>
                  <ul className="space-y-2 text-slate-500 dark:text-slate-400">
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg border-l-4 border-red-500">

    ...
    <div className="p-6 md:p-8 lg:p-12 max-w-4xl mx-auto">
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-3xl font-bold text-brand-600 dark:text-brand-300 mb-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 mb-6">
              <h3 className="text-xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('design_principles.event_driven.advantages_title')}</h3>
            ...
            <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-6">
              <h3 className="text-xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('design_principles.event_driven.example_title')}</h3>
          ...
          <section>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 mb-6">
              <h3 className="text-xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('design_principles.event_driven.tools_title')}</h3>
              <ul className="list-disc list-inside space-y-2 text-slate-600 dark:text-slate-300">
            ...
            <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-6">
              <h3 className="text-xl font-bold text-brand-600 dark:text-brand-200 mb-4">{t('design_principles.event_driven.dist_example_title')}</h3>
              <p className="text-slate-600 dark:text-slate-300">

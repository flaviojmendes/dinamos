...
export default function ReadingTime({ contentRef }: ReadingTimeProps) {
  ...
  return (
    <div className="px-4 py-2 bg-slate-100 dark:bg-slate-800/80 backdrop-blur-sm rounded-lg text-slate-600 dark:text-slate-300 text-sm flex items-center gap-2">

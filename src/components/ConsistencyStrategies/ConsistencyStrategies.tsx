    ...
    <div className="p-6 md:p-8 lg:p-12 max-w-7xl mx-auto">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Link 
          ...
          className="group bg-white dark:bg-slate-900 rounded-lg p-6 hover:bg-slate-100 dark:bg-slate-800 transition-colors"
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 text-sm">
                <span className="px-2 py-1 bg-blue-500/20 text-brand-600 dark:text-brand-300 rounded">Transações</span>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="px-2 py-1 bg-blue-500/20 text-brand-600 dark:text-brand-300 rounded">Acordo Distribuído</span>
              </div>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 text-sm">
                <span className="px-2 py-1 bg-blue-500/20 text-brand-600 dark:text-brand-300 rounded">Ordenação</span>

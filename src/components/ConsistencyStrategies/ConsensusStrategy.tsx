...
export default function ConsensusStrategy() {
  ...
  return (
    <div className="p-6 md:p-8 lg:p-12 max-w-7xl mx-auto">
      ...
      {/* Introduction */}
      <div className="bg-white dark:bg-slate-900 rounded-lg p-6 space-y-4 mb-8">
        <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200">{t('design_principles.consistency_strategies.consensus.what_is_title')}</h2>
      ...
      {/* Raft Protocol */}
      <div className="bg-white dark:bg-slate-900 rounded-lg p-6 space-y-4 mb-8">
        <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200 mb-4">{t('design_principles.consistency_strategies.consensus.raft_title')}</h2>
        <p className="text-slate-600 dark:text-slate-300">
        ...
        <div className="mt-4">
          <h3 className="text-xl font-semibold text-brand-600 dark:text-brand-400 mb-2">{t('design_principles.consistency_strategies.consensus.raft_example_title')}</h3>
          <p className="text-slate-600 dark:text-slate-300">
      ...
      {/* Paxos Protocol */}
      <div className="bg-white dark:bg-slate-900 rounded-lg p-6 space-y-4 mb-8">
        <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200 mb-4">{t('design_principles.consistency_strategies.consensus.paxos_title')}</h2>
        <p className="text-slate-600 dark:text-slate-300">
          {t('design_principles.consistency_strategies.consensus.paxos_intro')}
        </p>
        <div className="mt-4">
          <h3 className="text-xl font-semibold text-brand-600 dark:text-brand-400 mb-2">{t('design_principles.consistency_strategies.consensus.paxos_how_title')}</h3>
          <p className="text-slate-600 dark:text-slate-300">
      ...
      {/* ZooKeeper */}
      <div className="bg-white dark:bg-slate-900 rounded-lg p-6 space-y-4 mb-8">
        <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200 mb-4">{t('design_principles.consistency_strategies.consensus.zookeeper_title')}</h2>
        <p className="text-slate-600 dark:text-slate-300">
          {t('design_principles.consistency_strategies.consensus.zookeeper_intro')}
        </p>
        <div className="mt-4">
          <h3 className="text-xl font-semibold text-brand-600 dark:text-brand-400 mb-2">{t('design_principles.consistency_strategies.consensus.zookeeper_features_title')}</h3>
          <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 space-y-2">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200 mb-4">{t('design_principles.consistency_strategies.consensus.pros_cons_title')}</h2>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-slate-700 dark:text-slate-200 mb-2">{t('design_principles.consistency_strategies.consensus.cta_title')}</h2>
            <p className="text-slate-600 dark:text-slate-300">

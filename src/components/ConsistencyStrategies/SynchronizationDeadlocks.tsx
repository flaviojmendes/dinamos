    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mb-8">
          <strong className="block mb-2 text-brand-600 dark:text-brand-300">{t('design_principles.deadlocks.key_concept_label')}</strong>
        ...
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-lg p-4">
              <h3 className="text-lg font-semibold mb-3 text-brand-600 dark:text-brand-400">{t('design_principles.deadlocks.conditions.items.mutual_exclusion_title')}</h3>
            ...
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-lg p-4">
              <h3 className="text-lg font-semibold mb-3 text-brand-600 dark:text-brand-400">{t('design_principles.deadlocks.conditions.items.no_preemption_title')}</h3>
              <p className="text-slate-600 dark:text-slate-300">
        ...
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-lg p-4">
              <h3 className="text-lg font-semibold mb-3 text-brand-600 dark:text-brand-400">{t('design_principles.deadlocks.prevention.denial_title')}</h3>
        ...
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-slate-100 dark:bg-slate-800/50 rounded-lg p-4">
              <h3 className="text-lg font-semibold mb-3 text-brand-600 dark:text-brand-400">{t('design_principles.deadlocks.detection.centralized_title')}</h3>
              <p className="text-slate-600 dark:text-slate-300">
        ...
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/30 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link
              ...
              className="group bg-slate-100 dark:bg-slate-800/50 rounded-lg p-4 hover:bg-zinc-700/50 transition-colors"
            >
              <h3 className="text-lg font-semibold mb-2 text-brand-600 dark:text-brand-400 group-hover:text-brand-600 dark:text-brand-300">

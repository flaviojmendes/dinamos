  ...
  return (
    <div className="p-6 md:p-8 lg:p-12 max-w-7xl mx-auto">
      ...
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.two_phase_commit.overview_title')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-black/30 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">{t('design_principles.two_phase_commit.phase1_title')}</h3>
      ...
      {/* Características */}
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.two_phase_commit.features_title')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-black/30 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">{t('design_principles.two_phase_commit.advantages_title')}</h3>
      ...
      {/* Casos de Uso */}
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.two_phase_commit.use_cases_title')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-black/30 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">{t('design_principles.two_phase_commit.banking_title')}</h3>
      ...
      <div className="bg-zinc-900 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-zinc-200 mb-2">{t('design_principles.two_phase_commit.cta_title')}</h2>
            <p className="text-zinc-300">

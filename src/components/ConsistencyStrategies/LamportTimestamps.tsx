  ...
  return (
    <div className="p-6 md:p-8 lg:p-12 max-w-7xl mx-auto">
      ...
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.consistency_strategies.lamport_timestamps.overview_title')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-black/30 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">{t('design_principles.consistency_strategies.lamport_timestamps.problem_title')}</h3>
      ...
      {/* How it Works */}
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.consistency_strategies.lamport_timestamps.how_title')}</h2>
        <div className="space-y-6">
          <div className="bg-black/30 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">{t('design_principles.consistency_strategies.lamport_timestamps.basic_rules_title')}</h3>
      ...
      {/* Applications */}
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.consistency_strategies.lamport_timestamps.applications_title')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-black/30 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-400 mb-2">{t('design_principles.consistency_strategies.lamport_timestamps.use_cases_title')}</h3>
            <ul className="list-disc list-inside text-zinc-300 space-y-2">
      ...
      {/* Example */}
      <div className="bg-zinc-900 rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-zinc-200 mb-4">{t('design_principles.consistency_strategies.lamport_timestamps.example_title')}</h2>
        <div className="bg-black/30 p-4 rounded-lg">
          <h3 className="text-lg font-semibold text-blue-400 mb-4">{t('design_principles.consistency_strategies.lamport_timestamps.chat_system_title')}</h3>
      ...
      <div className="bg-zinc-900 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-zinc-200 mb-2">{t('design_principles.consistency_strategies.lamport_timestamps.cta_title')}</h2>
            <p className="text-zinc-300">

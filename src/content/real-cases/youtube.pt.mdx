...
Usuários → Web Server → MySQL → Storage

### 2008: Arquitetura Distribuída

Usuários → Load Balancer → Web Server → BigTable / GFS

### 2020+: Arquitetura Moderna

Usuários → Global CDN → Load Balancer → Upload Service / Transcode / ML Service / Analytics / Search

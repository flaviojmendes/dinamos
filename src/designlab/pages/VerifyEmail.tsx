        ...
        <Panel padded={false} bodyClassName="py-8 px-6" className="rounded-xl dark:rounded-none shadow-xl dark:shadow-none transition-colors duration-200">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-brand-100 dark:bg-tactical-raised border border-slate-200 dark:border-tactical-border rounded-full dark:rounded-none flex items-center justify-center">
              <svg className="w-10 h-10 text-brand-600 dark:text-signal-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {success && (
            <div className="mb-6 border border-signal-green/40 text-signal-green bg-signal-green/10 px-4 py-3 text-sm font-mono dark:rounded-none">
              {success}
            </div>
          )}
          ...
          <div className="text-center mb-6">
            ...
            <p className="font-mono text-sm uppercase tracking-wider font-medium text-slate-900 dark:text-tactical-text">
              {currentUser?.email}
            </p>
          </div>

          <div className="border border-signal-amber/40 bg-signal-amber/10 dark:rounded-none p-4 mb-6">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-slate-700 dark:text-tactical-dim">
                <p className="font-mono uppercase tracking-wider text-xs text-signal-amber mb-1">Não recebeu o email?</p>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200 dark:border-tactical-border">
            ...
            >
              Usar outro email? <span className="font-mono uppercase tracking-wider underline text-brand-600 dark:text-signal-cyan">Sair</span>
            </button>
          </div>
        </Panel>
      </div>

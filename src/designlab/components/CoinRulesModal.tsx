...
export default function CoinRulesModal({ isOpen, onClose }: CoinRulesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="tactical-panel dark:rounded-none w-full max-w-2xl card-shadow max-h-[90vh] overflow-y-auto bg-white dark:bg-tactical-surface">
        <div className="p-6 border-b border-slate-200 dark:border-tactical-border flex justify-between items-center sticky top-0 bg-white dark:bg-tactical-surface z-10">
          <div className="flex items-center gap-3">
            <div className="p-2 border border-signal-amber/40 bg-signal-amber/10 dark:rounded-none">
          ...
          <button
            onClick={onClose}
            className="text-slate-500 dark:text-tactical-dim hover:text-slate-900 dark:hover:text-tactical-text transition-colors p-2 hover:bg-slate-100 dark:hover:bg-tactical-raised dark:rounded-none"
            aria-label="Fechar"
          >
            <X className="h-6 w-6" />
          </button>
        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="tactical-panel dark:rounded-none p-4 hover:border-signal-amber/40 transition-colors">
                <div className="flex items-start justify-between mb-2">
                  <div className="p-2 border border-signal-cyan/40 bg-signal-cyan/10 text-signal-cyan dark:rounded-none">
              ...
              <div className="tactical-panel dark:rounded-none p-4 hover:border-signal-amber/40 transition-colors">
                <div className="flex items-start justify-between mb-2">
                  <div className="p-2 border border-signal-green/40 bg-signal-green/10 text-signal-green dark:rounded-none">
              ...
              <div className="tactical-panel dark:rounded-none p-4 hover:border-signal-amber/40 transition-colors col-span-full sm:col-span-1">
                <div className="flex items-start justify-between mb-2">
                  <div className="p-2 border border-brand-500/40 bg-brand-500/10 text-brand-600 dark:text-signal-cyan dark:rounded-none">
                    <MessageCircle className="h-5 w-5" />
                  </div>
                  <span className={coinAmountClass}>+2 moedas</span>
                </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex gap-4 p-4 tactical-panel dark:rounded-none">
                <div className="p-2 border border-signal-amber/40 bg-signal-amber/10 h-fit dark:rounded-none">
                  <Star className="h-5 w-5 text-signal-amber" />
                </div>
                <div>
              ...
              <div className="flex gap-4 p-4 tactical-panel dark:rounded-none">
                <div className="p-2 border border-signal-red/40 bg-signal-red/10 h-fit dark:rounded-none">
        ...
        <div className="p-6 border-t border-slate-200 dark:border-tactical-border bg-white dark:bg-tactical-surface sticky bottom-0">
          <TacticalButton variant="secondary" className="w-full dark:rounded-none" onClick={onClose}>
            Entendi
          </TacticalButton>
        </div>
      </div>

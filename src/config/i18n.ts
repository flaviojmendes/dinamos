  ...
  en: {
    translation: {
      ...
      heatmap: {
        ...
        summary_suffix: 'activities in the last year',
        ...
        count_actions: '{{count}} activities',
        count_actions_one: '{{count}} activity',
      ...
      editor: {
        ...
        save: {
          ...
          sign_in_to_save: 'Sign in to save & share',
          error: 'Could not save the architecture.',
          load_error: 'Could not load that architecture.',
          loading: 'Loading…',
          empty: 'No saved architectures yet. Build something and hit Save.',
          untitled: 'Untitled architecture',
          delete: 'Delete',
          copy: 'Copy',
          copied: 'Copied',
          share_title: 'Share this architecture',
          title_label: 'Title',
          title_placeholder: 'Untitled architecture',
          visibility_label: 'Visibility',
          visibility_private: 'Private (only me)',
          visibility_unlisted: 'Unlisted (anyone with the link)',
          visibility_public: 'Public (anyone with the link)',
          visibility_private_short: 'Private',
          visibility_unlisted_short: 'Unlisted',
          visibility_public_short: 'Public',
          link_label: 'Share link',
          embed_label: 'Embed (iframe)',
          private_hint: 'Set visibility to Unlisted or Public to get a shareable link and embed code.',
          save_to_share: 'Save this architecture to generate a share link and embed code.',
          save_and_share: 'Save & create link',
          embed_not_found: 'This architecture is unavailable. It may be private or no longer exist.'
        },
        kinds: {
          client: 'Client',
        ...
        hints: {
          ...
          cron: 'Turn this service into a scheduled (cron) source: it generates its own work on a timer and needs no incoming connection. Use it for cron jobs, recurring workers and periodic producers.',
          cron_rate: 'Self-generated requests per second when cron is on. Higher = more scheduled work injected; lower = a lighter periodic trickle.',
          auto_scalable: 'Let this service scale its own replicas at runtime to hold the target utilization, bounded by min/max replicas — no separate auto-scaler node needed.',
        ...
        inspector: {
          ...
          label: 'Label',
          base_rate: 'Base rate',
          cron: 'Cron (self-trigger)',
          cron_rate: 'Cron rate',
          auto_scalable: 'Auto-scalable',
        ...
        canvas: {
          empty_title: 'Build your first system',
          empty_hint: 'Drag a component from the palette onto the canvas, then drag between handles to connect nodes.',
          empty_hint_touch: 'Tap Components to add a node, then drag between handles to connect them.'
        },
        errors: {
        ...
        game: {
          next_round_name: 'Next: {{name}}',
          round_score: 'Round',
          streak_hint: 'SLO streak: keep errors <1% and p95 under target to grow your score multiplier.',
          scenario: 'Scenario',
          scenario_custom: 'Custom (build your own)',
          scripted_chaos: 'scripted chaos',
          open_stage: 'Audience screen',
          console: 'Host console',
          console_title: 'Host a Match',
          console_subtitle: 'Pick a scenario, create the match, then share the join link with your players and the stage link with your audience.',
          back_to_arena: 'Back to the arena',
          matches: 'Your matches',
          copied: 'Copied',
          copy_invite: 'Copy invite link',
          delete_confirm: 'Delete this match permanently?',
          stage: 'Stage',
          manage: 'Manage',
          delete_match: 'Delete match',
          joining: 'Joining',
          join_public: 'Public',
          join_private: 'Private',
          join_public_hint: 'Anyone with the match code can join.',
          join_private_hint: 'Only people with your invite link can join. The link is generated when the match is created.',
          arena_listing: 'Arena listing',
          listed_label: 'Show in “Happening now” on the arena',
          listed_hint: 'Visitors browsing the arena will see this match.',
          unlisted_hint: 'Hidden from the arena. Only people with the link will find it.',
          chip_private: 'Invite only',
          chip_unlisted: 'Unlisted',
          open_joining: 'Open joining',
          ...
          fx: {
            ...
            partition_incoming: '{{target}} network partition in {{sec}}s',
            kill_active: '{{target}} is DOWN · {{sec}}s remaining',
            slow_active: '{{target}} degraded · {{sec}}s remaining',
            partition_active: '{{target}} partitioned · {{sec}}s remaining',
            rank_up: "You're #{{rank}}",
            rank_down: 'Dropped to #{{rank}}',
            round_start: 'Round {{n}}',
            round_over: 'Round {{n}} over',
            go: 'Go!',
            hands_off: 'Scores are in'
          },
          results: {
            final_title: 'Final standings',
            round_title: 'Round {{n}} results',
            close: 'Close results',
            you_finished: 'You finished #{{rank}} with {{score}} points',
            points: 'points',
            rank_now: 'Rank',
        ...
        stage: {
          ...
          final: 'FINAL',
          lobby: 'LOBBY',
          building_now: 'Players are building',
      ...
      arena: {
        badge: 'ARENA',
        cta_dinamos: 'Learn on dinamos.net',
        headline: 'Build systems. Survive chaos.',
        headline_accent: 'Top the leaderboard.',
        subhead: 'A real-time multiplayer game where every player architects a distributed system against the same live traffic and the same failures. Black Friday rushes, datacenter outages, viral floods: in your browser, with friends, scored every second.',
        live_chip_one: '{{count}} match live right now',
        live_chip_other: '{{count}} matches live right now',
        cta_host: 'Host a match',
        cta_watch: 'Watch live matches',
        cta_join: 'Join',
        code_ph: 'MATCH CODE',
        live: 'LIVE',
        lobby: 'LOBBY',
        building: 'BUILD',
        untitled: 'Distributed Systems Match',
        round_of: 'Round {{n}}/{{total}}',
        watch: 'Watch',
        join: 'Join',
        invite_only: 'Invite only',
        invite_only_hint: 'The host shares the invite link directly with players.',
        live_title: 'Happening now',
        live_sub: 'Open matches you can watch on the big screen or jump into.',
        no_live: 'No live matches right now. Be the one who starts the next game.',
        how_title: 'How a match works',
        step1_title: 'Host & invite',
        step1_body: 'Pick a real-world scenario, create the match, and share one link. Players join from any browser; the audience gets a live stage screen.',
        step2_title: 'Build under fire',
        step2_body: 'Design your architecture in the build phase: load balancers, caches, queues, replicas. When the round locks, live traffic hits every player at once.',
        step3_title: 'Survive chaos, score big',
        step3_body: 'Outages and slowdowns strike mid-round. Keep latency and errors inside the SLO to build a streak multiplier. Resilience beats raw spend.',
        scenarios_title: 'Battle-tested scenarios',
        scenarios_sub: 'Every match replays a real operational incident: scripted traffic, scripted failures, tuned scoring.',
        rounds: 'rounds',
        chaos_events: 'chaos events',
        closing_title: 'Your move, architect.',
        closing_sub: 'Free, in the browser, no setup. Host a match for your team, your class, or your meetup, and put the audience screen on the projector.',
        footer_tag: 'The Arena runs on Dinamos, the free hands-on platform for distributed systems.',
        footer_cta: 'Explore the lessons on dinamos.net'
      },
      challenges: {
  ...
  pt: {
    translation: {
      ...
      heatmap: {
        ...
        summary_suffix: 'atividades no último ano',
        ...
        count_actions: '{{count}} atividades',
        count_actions_one: '{{count}} atividade',
      ...
      editor: {
        ...
        save: {
          ...
          saving: 'Salvando…',
          share: 'Compartilhar',
          my_designs: 'Meus designs',
          sign_in_to_save: 'Entre para salvar e compartilhar',
          error: 'Não foi possível salvar a arquitetura.',
          load_error: 'Não foi possível carregar essa arquitetura.',
          loading: 'Carregando…',
          empty: 'Nenhuma arquitetura salva ainda. Monte algo e clique em Salvar.',
          untitled: 'Arquitetura sem título',
          delete: 'Excluir',
          copy: 'Copiar',
          copied: 'Copiado',
          share_title: 'Compartilhar esta arquitetura',
          title_label: 'Título',
          title_placeholder: 'Arquitetura sem título',
          visibility_label: 'Visibilidade',
          visibility_private: 'Privada (somente eu)',
          visibility_unlisted: 'Não listada (qualquer pessoa com o link)',
          visibility_public: 'Pública (qualquer pessoa com o link)',
          visibility_private_short: 'Privada',
          visibility_unlisted_short: 'Não listada',
          visibility_public_short: 'Pública',
          link_label: 'Link de compartilhamento',
          embed_label: 'Incorporar (iframe)',
          private_hint: 'Defina a visibilidade como Não listada ou Pública para obter um link e código de incorporação.',
          save_to_share: 'Salve esta arquitetura para gerar um link de compartilhamento e código de incorporação.',
          save_and_share: 'Salvar e criar link',
          embed_not_found: 'Esta arquitetura não está disponível. Pode ser privada ou não existir mais.'
        },
        kinds: {
          client: 'Cliente',
        ...
        hints: {
          ...
          cron: 'Transforma este serviço em uma fonte agendada (cron): ele gera o próprio trabalho por temporizador e não precisa de conexão de entrada. Use para tarefas cron, workers recorrentes e produtores periódicos.',
          cron_rate: 'Requisições geradas por segundo quando o cron está ligado. Maior = mais trabalho agendado injetado; menor = um fluxo periódico mais leve.',
          auto_scalable: 'Permite que este serviço ajuste as próprias réplicas em tempo de execução para manter a utilização alvo, limitado por mín/máx de réplicas — sem precisar de um nó auto-scaler separado.',
        ...
        inspector: {
          ...
          label: 'Rótulo',
          base_rate: 'Taxa base',
          cron: 'Cron (auto-disparo)',
          cron_rate: 'Taxa do cron',
          auto_scalable: 'Auto-escalável',
        ...
        canvas: {
          empty_title: 'Monte seu primeiro sistema',
          empty_hint: 'Arraste um componente da paleta para o canvas e conecte os nós arrastando entre os pontos de conexão.',
          empty_hint_touch: 'Toque em Componentes para adicionar um nó e arraste entre os pontos de conexão para ligá-los.'
        },
        errors: {
        ...
        game: {
          next_round_name: 'Próxima: {{name}}',
          round_score: 'Rodada',
          streak_hint: 'Sequência de SLO: mantenha erros <1% e p95 abaixo da meta para aumentar seu multiplicador de pontos.',
          scenario: 'Cenário',
          scenario_custom: 'Personalizado (monte o seu)',
          scripted_chaos: 'caos programado',
          open_stage: 'Telão da plateia',
          console: 'Console do anfitrião',
          console_title: 'Crie uma Partida',
          console_subtitle: 'Escolha um cenário, crie a partida e compartilhe o link de entrada com os jogadores e o link do telão com a plateia.',
          back_to_arena: 'Voltar para a arena',
          matches: 'Suas partidas',
          copied: 'Copiado',
          copy_invite: 'Copiar link de convite',
          delete_confirm: 'Excluir esta partida permanentemente?',
          stage: 'Telão',
          manage: 'Gerenciar',
          delete_match: 'Excluir partida',
          joining: 'Entrada',
          join_public: 'Pública',
          join_private: 'Privada',
          join_public_hint: 'Qualquer pessoa com o código da partida pode entrar.',
          join_private_hint: 'Só quem tem seu link de convite pode entrar. O link é gerado ao criar a partida.',
          arena_listing: 'Listagem na arena',
          listed_label: 'Mostrar em “Acontecendo agora” na arena',
          listed_hint: 'Visitantes da arena verão esta partida.',
          unlisted_hint: 'Oculta da arena. Só quem tem o link vai encontrá-la.',
          chip_private: 'Só com convite',
          chip_unlisted: 'Não listada',
          open_joining: 'Entrada aberta',
          ...
          fx: {
            ...
            partition_incoming: 'Partição de rede em {{target}} em {{sec}}s',
            kill_active: '{{target}} está FORA DO AR · faltam {{sec}}s',
            slow_active: '{{target}} degradado · faltam {{sec}}s',
            partition_active: '{{target}} particionado · faltam {{sec}}s',
            rank_up: 'Você está em #{{rank}}',
            rank_down: 'Caiu para #{{rank}}',
            round_start: 'Rodada {{n}}',
            round_over: 'Fim da rodada {{n}}',
            go: 'Valendo!',
            hands_off: 'Pontuação registrada'
          },
          results: {
            final_title: 'Classificação final',
            round_title: 'Resultado da rodada {{n}}',
            close: 'Fechar resultados',
            you_finished: 'Você terminou em #{{rank}} com {{score}} pontos',
            points: 'pontos',
            rank_now: 'Posição',
        ...
        stage: {
          ...
          final: 'FINAL',
          lobby: 'LOBBY',
          building_now: 'Jogadores construindo',
          match_over: 'Partida encerrada',
          join_at: 'Entre em',
          champion: 'Campeão',
          standings: 'Classificação',
          waiting_players: 'Aguardando jogadores entrarem…'
        }
      },
      arena: {
        badge: 'ARENA',
        cta_dinamos: 'Aprenda no dinamos.net',
        headline: 'Construa sistemas. Sobreviva ao caos.',
        headline_accent: 'Domine o placar.',
        subhead: 'Um jogo multiplayer em tempo real onde cada jogador projeta um sistema distribuído contra o mesmo tráfego ao vivo e as mesmas falhas. Black Friday, quedas de datacenter, picos virais: no navegador, com amigos, pontuado a cada segundo.',
        live_chip_one: '{{count}} partida ao vivo agora',
        live_chip_other: '{{count}} partidas ao vivo agora',
        cta_host: 'Criar partida',
        cta_watch: 'Assistir partidas ao vivo',
        cta_join: 'Entrar',
        code_ph: 'CÓDIGO',
        live: 'AO VIVO',
        lobby: 'LOBBY',
        building: 'CONSTRUÇÃO',
        untitled: 'Partida de Sistemas Distribuídos',
        round_of: 'Rodada {{n}}/{{total}}',
        watch: 'Assistir',
        join: 'Entrar',
        invite_only: 'Só com convite',
        invite_only_hint: 'O anfitrião compartilha o link de convite diretamente com os jogadores.',
        live_title: 'Acontecendo agora',
        live_sub: 'Partidas abertas para assistir no telão ou entrar na hora.',
        no_live: 'Nenhuma partida ao vivo agora. Seja quem começa o próximo jogo.',
        how_title: 'Como funciona uma partida',
        step1_title: 'Crie e convide',
        step1_body: 'Escolha um cenário do mundo real, crie a partida e compartilhe um link. Jogadores entram de qualquer navegador; a plateia ganha um telão ao vivo.',
        step2_title: 'Construa sob pressão',
        step2_body: 'Projete sua arquitetura na fase de construção: load balancers, caches, filas, réplicas. Quando a rodada trava, o tráfego ao vivo atinge todos ao mesmo tempo.',
        step3_title: 'Sobreviva ao caos e pontue',
        step3_body: 'Quedas e lentidões atacam no meio da rodada. Mantenha latência e erros dentro do SLO para construir um multiplicador de sequência. Resiliência vale mais que gasto bruto.',
        scenarios_title: 'Cenários testados em batalha',
        scenarios_sub: 'Cada partida reencena um incidente operacional real: tráfego roteirizado, falhas roteirizadas, pontuação calibrada.',
        rounds: 'rodadas',
        chaos_events: 'eventos de caos',
        closing_title: 'Sua vez, arquiteto.',
        closing_sub: 'Grátis, no navegador, sem instalação. Crie uma partida para seu time, sua turma ou seu meetup, e coloque o telão da plateia no projetor.',
        footer_tag: 'A Arena roda no Dinamos, a plataforma gratuita e prática de sistemas distribuídos.',
        footer_cta: 'Explore as lições no dinamos.net'
      },
      challenges: {
